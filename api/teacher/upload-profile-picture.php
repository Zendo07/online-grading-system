...
if ($result['success']) {
    try {
        ...
        // UPDATE SESSION IMMEDIATELY - This is key!
        ...
        // Get the full profile picture URL to return to frontend
        $picture_url = getProfilePicture($result['filename'], $_SESSION['full_name']);
        
        echo json_encode([
            'success' => true,
            'message' => 'Profile picture updated successfully',
            'filename' => $result['filename'],
            'picture_url' => $picture_url  // Return the full URL
        ]);
