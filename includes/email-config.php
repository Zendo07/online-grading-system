...
<head>
    ...
    <style>
        ...
        .button { display: inline-block; background: #7b2d26; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin: 10px 0; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="font-size: 12px; color: #666;">
                <strong>Security Note:</strong> If you didn't create an account with IndEX, please ignore this email. Your email address will not be used without verification.
            </p>
        </div>
        <div class="footer">
